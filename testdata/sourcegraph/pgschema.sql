...
--
-- Name: _int_contained(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_contained() RETURNS boolean
    LANGUAGE c
    AS $$_int_contained$$;
--
-- Name: _int_contained_joinsel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_contained_joinsel() RETURNS double precision
    LANGUAGE c
    AS $$_int_contained_joinsel$$;
--
-- Name: _int_contained_sel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_contained_sel() RETURNS double precision
    LANGUAGE c
    AS $$_int_contained_sel$$;
--
-- Name: _int_contains(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_contains() RETURNS boolean
    LANGUAGE c
    AS $$_int_contains$$;
--
-- Name: _int_contains_joinsel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_contains_joinsel() RETURNS double precision
    LANGUAGE c
    AS $$_int_contains_joinsel$$;
--
-- Name: _int_contains_sel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_contains_sel() RETURNS double precision
    LANGUAGE c
    AS $$_int_contains_sel$$;
--
-- Name: _int_different(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_different() RETURNS boolean
    LANGUAGE c
    AS $$_int_different$$;
--
-- Name: _int_inter(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_inter() RETURNS ARRAY
    LANGUAGE c
    AS $$_int_inter$$;
--
-- Name: _int_matchsel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_matchsel() RETURNS double precision
    LANGUAGE c
    AS $$_int_matchsel$$;
--
-- Name: _int_overlap(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_overlap() RETURNS boolean
    LANGUAGE c
    AS $$_int_overlap$$;
--
-- Name: _int_overlap_joinsel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_overlap_joinsel() RETURNS double precision
    LANGUAGE c
    AS $$_int_overlap_joinsel$$;
--
-- Name: _int_overlap_sel(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_overlap_sel() RETURNS double precision
    LANGUAGE c
    AS $$_int_overlap_sel$$;
--
-- Name: _int_same(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_same() RETURNS boolean
    LANGUAGE c
    AS $$_int_same$$;
--
-- Name: _int_union(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._int_union() RETURNS ARRAY
    LANGUAGE c
    AS $$_int_union$$;
--
-- Name: _intbig_in(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._intbig_in() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$_intbig_in$$;
--
-- Name: _intbig_out(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public._intbig_out() RETURNS cstring
    LANGUAGE c
    AS $$_intbig_out$$;
--
-- Name: akeys(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.akeys() RETURNS ARRAY
    LANGUAGE c
    AS $$hstore_akeys$$;
--
-- Name: armor(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.armor() RETURNS text
    LANGUAGE c
    AS $$pg_armor$$;
--
-- Name: avals(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.avals() RETURNS ARRAY
    LANGUAGE c
    AS $$hstore_avals$$;
--
...
END $$;
--
-- Name: boolop(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.boolop() RETURNS boolean
    LANGUAGE c
    AS $$boolop$$;
--
-- Name: bqarr_in(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.bqarr_in() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$bqarr_in$$;
--
-- Name: bqarr_out(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.bqarr_out() RETURNS cstring
    LANGUAGE c
    AS $$bqarr_out$$;
--
...
END $$;
--
-- Name: citext(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext() RETURNS USER-DEFINED
    LANGUAGE internal
    AS $$booltext$$;
--
-- Name: citext_cmp(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_cmp() RETURNS integer
    LANGUAGE c
    AS $$citext_cmp$$;
--
-- Name: citext_eq(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_eq() RETURNS boolean
    LANGUAGE c
    AS $$citext_eq$$;
--
-- Name: citext_ge(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_ge() RETURNS boolean
    LANGUAGE c
    AS $$citext_ge$$;
--
-- Name: citext_gt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_gt() RETURNS boolean
    LANGUAGE c
    AS $$citext_gt$$;
--
-- Name: citext_hash(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_hash() RETURNS integer
    LANGUAGE c
    AS $$citext_hash$$;
--
-- Name: citext_hash_extended(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_hash_extended() RETURNS bigint
    LANGUAGE c
    AS $$citext_hash_extended$$;
--
-- Name: citext_larger(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_larger() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$citext_larger$$;
--
-- Name: citext_le(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_le() RETURNS boolean
    LANGUAGE c
    AS $$citext_le$$;
--
-- Name: citext_lt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_lt() RETURNS boolean
    LANGUAGE c
    AS $$citext_lt$$;
--
-- Name: citext_ne(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_ne() RETURNS boolean
    LANGUAGE c
    AS $$citext_ne$$;
--
-- Name: citext_pattern_cmp(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_pattern_cmp() RETURNS integer
    LANGUAGE c
    AS $$citext_pattern_cmp$$;
--
-- Name: citext_pattern_ge(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_pattern_ge() RETURNS boolean
    LANGUAGE c
    AS $$citext_pattern_ge$$;
--
-- Name: citext_pattern_gt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_pattern_gt() RETURNS boolean
    LANGUAGE c
    AS $$citext_pattern_gt$$;
--
-- Name: citext_pattern_le(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_pattern_le() RETURNS boolean
    LANGUAGE c
    AS $$citext_pattern_le$$;
--
-- Name: citext_pattern_lt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_pattern_lt() RETURNS boolean
    LANGUAGE c
    AS $$citext_pattern_lt$$;
--
-- Name: citext_smaller(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citext_smaller() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$citext_smaller$$;
--
-- Name: citextin(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citextin() RETURNS USER-DEFINED
    LANGUAGE internal
    AS $$textin$$;
--
-- Name: citextout(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citextout() RETURNS cstring
    LANGUAGE internal
    AS $$textout$$;
--
-- Name: citextrecv(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citextrecv() RETURNS USER-DEFINED
    LANGUAGE internal
    AS $$textrecv$$;
--
-- Name: citextsend(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.citextsend() RETURNS bytea
    LANGUAGE internal
    AS $$textsend$$;
--
-- Name: crypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.crypt() RETURNS text
    LANGUAGE c
    AS $$pg_crypt$$;
--
-- Name: dearmor(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.dearmor() RETURNS bytea
    LANGUAGE c
    AS $$pg_dearmor$$;
--
-- Name: decrypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.decrypt() RETURNS bytea
    LANGUAGE c
    AS $$pg_decrypt$$;
--
-- Name: decrypt_iv(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.decrypt_iv() RETURNS bytea
    LANGUAGE c
    AS $$pg_decrypt_iv$$;
--
-- Name: defined(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.defined() RETURNS boolean
    LANGUAGE c
    AS $$hstore_defined$$;
--
-- Name: delete(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.delete() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_delete_array$$;
--
...
$$;
--
-- Name: digest(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.digest() RETURNS bytea
    LANGUAGE c
    AS $$pg_digest$$;
--
-- Name: each(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.each() RETURNS record
    LANGUAGE c
    AS $$hstore_each$$;
--
-- Name: encrypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.encrypt() RETURNS bytea
    LANGUAGE c
    AS $$pg_encrypt$$;
--
-- Name: encrypt_iv(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.encrypt_iv() RETURNS bytea
    LANGUAGE c
    AS $$pg_encrypt_iv$$;
--
-- Name: exist(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.exist() RETURNS boolean
    LANGUAGE c
    AS $$hstore_exists$$;
--
-- Name: exists_all(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.exists_all() RETURNS boolean
    LANGUAGE c
    AS $$hstore_exists_all$$;
--
-- Name: exists_any(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.exists_any() RETURNS boolean
    LANGUAGE c
    AS $$hstore_exists_any$$;
--
...
$$;
--
-- Name: fetchval(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fetchval() RETURNS text
    LANGUAGE c
    AS $$hstore_fetchval$$;
--
...
$$;
--
-- Name: g_int_compress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_compress() RETURNS internal
    LANGUAGE c
    AS $$g_int_compress$$;
--
-- Name: g_int_consistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_consistent() RETURNS boolean
    LANGUAGE c
    AS $$g_int_consistent$$;
--
-- Name: g_int_decompress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_decompress() RETURNS internal
    LANGUAGE c
    AS $$g_int_decompress$$;
--
-- Name: g_int_options(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_options() RETURNS void
    LANGUAGE c
    AS $$g_int_options$$;
--
-- Name: g_int_penalty(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_penalty() RETURNS internal
    LANGUAGE c
    AS $$g_int_penalty$$;
--
-- Name: g_int_picksplit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_picksplit() RETURNS internal
    LANGUAGE c
    AS $$g_int_picksplit$$;
--
-- Name: g_int_same(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_same() RETURNS internal
    LANGUAGE c
    AS $$g_int_same$$;
--
-- Name: g_int_union(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_int_union() RETURNS ARRAY
    LANGUAGE c
    AS $$g_int_union$$;
--
-- Name: g_intbig_compress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_compress() RETURNS internal
    LANGUAGE c
    AS $$g_intbig_compress$$;
--
-- Name: g_intbig_consistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_consistent() RETURNS boolean
    LANGUAGE c
    AS $$g_intbig_consistent$$;
--
-- Name: g_intbig_decompress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_decompress() RETURNS internal
    LANGUAGE c
    AS $$g_intbig_decompress$$;
--
-- Name: g_intbig_options(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_options() RETURNS void
    LANGUAGE c
    AS $$g_intbig_options$$;
--
-- Name: g_intbig_penalty(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_penalty() RETURNS internal
    LANGUAGE c
    AS $$g_intbig_penalty$$;
--
-- Name: g_intbig_picksplit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_picksplit() RETURNS internal
    LANGUAGE c
    AS $$g_intbig_picksplit$$;
--
-- Name: g_intbig_same(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_same() RETURNS internal
    LANGUAGE c
    AS $$g_intbig_same$$;
--
-- Name: g_intbig_union(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.g_intbig_union() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$g_intbig_union$$;
--
-- Name: gen_random_bytes(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gen_random_bytes() RETURNS bytea
    LANGUAGE c
    AS $$pg_random_bytes$$;
--
...
CREATE FUNCTION public.gen_random_uuid() RETURNS uuid
    ...
    AS $$pg_random_uuid$$;
--
-- Name: gen_salt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gen_salt() RETURNS text
    LANGUAGE c
    AS $$pg_gen_salt$$;
--
-- Name: ghstore_compress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_compress() RETURNS internal
    LANGUAGE c
    AS $$ghstore_compress$$;
--
-- Name: ghstore_consistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_consistent() RETURNS boolean
    LANGUAGE c
    AS $$ghstore_consistent$$;
--
-- Name: ghstore_decompress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_decompress() RETURNS internal
    LANGUAGE c
    AS $$ghstore_decompress$$;
--
-- Name: ghstore_in(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_in() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$ghstore_in$$;
--
-- Name: ghstore_options(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_options() RETURNS void
    LANGUAGE c
    AS $$ghstore_options$$;
--
-- Name: ghstore_out(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_out() RETURNS cstring
    LANGUAGE c
    AS $$ghstore_out$$;
--
-- Name: ghstore_penalty(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_penalty() RETURNS internal
    LANGUAGE c
    AS $$ghstore_penalty$$;
--
-- Name: ghstore_picksplit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_picksplit() RETURNS internal
    LANGUAGE c
    AS $$ghstore_picksplit$$;
--
-- Name: ghstore_same(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_same() RETURNS internal
    LANGUAGE c
    AS $$ghstore_same$$;
--
-- Name: ghstore_union(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ghstore_union() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$ghstore_union$$;
--
-- Name: gin_consistent_hstore(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_consistent_hstore() RETURNS boolean
    LANGUAGE c
    AS $$gin_consistent_hstore$$;
--
-- Name: gin_extract_hstore(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_extract_hstore() RETURNS internal
    LANGUAGE c
    AS $$gin_extract_hstore$$;
--
-- Name: gin_extract_hstore_query(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_extract_hstore_query() RETURNS internal
    LANGUAGE c
    AS $$gin_extract_hstore_query$$;
--
-- Name: gin_extract_query_trgm(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_extract_query_trgm() RETURNS internal
    LANGUAGE c
    AS $$gin_extract_query_trgm$$;
--
-- Name: gin_extract_value_trgm(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_extract_value_trgm() RETURNS internal
    LANGUAGE c
    AS $$gin_extract_value_trgm$$;
--
-- Name: gin_trgm_consistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_trgm_consistent() RETURNS boolean
    LANGUAGE c
    AS $$gin_trgm_consistent$$;
--
-- Name: gin_trgm_triconsistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gin_trgm_triconsistent() RETURNS "char"
    LANGUAGE c
    AS $$gin_trgm_triconsistent$$;
--
-- Name: ginint4_consistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ginint4_consistent() RETURNS boolean
    LANGUAGE c
    AS $$ginint4_consistent$$;
--
-- Name: ginint4_queryextract(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ginint4_queryextract() RETURNS internal
    LANGUAGE c
    AS $$ginint4_queryextract$$;
--
-- Name: gtrgm_compress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_compress() RETURNS internal
    LANGUAGE c
    AS $$gtrgm_compress$$;
--
-- Name: gtrgm_consistent(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_consistent() RETURNS boolean
    LANGUAGE c
    AS $$gtrgm_consistent$$;
--
-- Name: gtrgm_decompress(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_decompress() RETURNS internal
    LANGUAGE c
    AS $$gtrgm_decompress$$;
--
-- Name: gtrgm_distance(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_distance() RETURNS double precision
    LANGUAGE c
    AS $$gtrgm_distance$$;
--
-- Name: gtrgm_in(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_in() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$gtrgm_in$$;
--
-- Name: gtrgm_options(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_options() RETURNS void
    LANGUAGE c
    AS $$gtrgm_options$$;
--
-- Name: gtrgm_out(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_out() RETURNS cstring
    LANGUAGE c
    AS $$gtrgm_out$$;
--
-- Name: gtrgm_penalty(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_penalty() RETURNS internal
    LANGUAGE c
    AS $$gtrgm_penalty$$;
--
-- Name: gtrgm_picksplit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_picksplit() RETURNS internal
    LANGUAGE c
    AS $$gtrgm_picksplit$$;
--
-- Name: gtrgm_same(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_same() RETURNS internal
    LANGUAGE c
    AS $$gtrgm_same$$;
--
-- Name: gtrgm_union(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.gtrgm_union() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$gtrgm_union$$;
--
-- Name: hmac(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hmac() RETURNS bytea
    LANGUAGE c
    AS $$pg_hmac$$;
--
-- Name: hs_concat(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hs_concat() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_concat$$;
--
-- Name: hs_contained(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hs_contained() RETURNS boolean
    LANGUAGE c
    AS $$hstore_contained$$;
--
-- Name: hs_contains(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hs_contains() RETURNS boolean
    LANGUAGE c
    AS $$hstore_contains$$;
--
-- Name: hstore(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_from_array$$;
--
-- Name: hstore_cmp(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_cmp() RETURNS integer
    LANGUAGE c
    AS $$hstore_cmp$$;
--
-- Name: hstore_eq(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_eq() RETURNS boolean
    LANGUAGE c
    AS $$hstore_eq$$;
--
-- Name: hstore_ge(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_ge() RETURNS boolean
    LANGUAGE c
    AS $$hstore_ge$$;
--
-- Name: hstore_gt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_gt() RETURNS boolean
    LANGUAGE c
    AS $$hstore_gt$$;
--
-- Name: hstore_hash(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_hash() RETURNS integer
    LANGUAGE c
    AS $$hstore_hash$$;
--
-- Name: hstore_hash_extended(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_hash_extended() RETURNS bigint
    LANGUAGE c
    AS $$hstore_hash_extended$$;
--
-- Name: hstore_in(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_in() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_in$$;
--
-- Name: hstore_le(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_le() RETURNS boolean
    LANGUAGE c
    AS $$hstore_le$$;
--
-- Name: hstore_lt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_lt() RETURNS boolean
    LANGUAGE c
    AS $$hstore_lt$$;
--
-- Name: hstore_ne(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_ne() RETURNS boolean
    LANGUAGE c
    AS $$hstore_ne$$;
--
-- Name: hstore_out(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_out() RETURNS cstring
    LANGUAGE c
    AS $$hstore_out$$;
--
-- Name: hstore_recv(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_recv() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_recv$$;
--
-- Name: hstore_send(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_send() RETURNS bytea
    LANGUAGE c
    AS $$hstore_send$$;
--
-- Name: hstore_subscript_handler(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_subscript_handler() RETURNS internal
    LANGUAGE c
    AS $$hstore_subscript_handler$$;
--
-- Name: hstore_to_array(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_to_array() RETURNS ARRAY
    LANGUAGE c
    AS $$hstore_to_array$$;
--
-- Name: hstore_to_json(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_to_json() RETURNS json
    LANGUAGE c
    AS $$hstore_to_json$$;
--
-- Name: hstore_to_json_loose(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_to_json_loose() RETURNS json
    LANGUAGE c
    AS $$hstore_to_json_loose$$;
--
-- Name: hstore_to_jsonb(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_to_jsonb() RETURNS jsonb
    LANGUAGE c
    AS $$hstore_to_jsonb$$;
--
-- Name: hstore_to_jsonb_loose(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_to_jsonb_loose() RETURNS jsonb
    LANGUAGE c
    AS $$hstore_to_jsonb_loose$$;
--
-- Name: hstore_to_matrix(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_to_matrix() RETURNS ARRAY
    LANGUAGE c
    AS $$hstore_to_matrix$$;
--
-- Name: hstore_version_diag(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.hstore_version_diag() RETURNS integer
    LANGUAGE c
    AS $$hstore_version_diag$$;
--
-- Name: icount(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.icount() RETURNS integer
    LANGUAGE c
    AS $$icount$$;
--
-- Name: idx(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.idx() RETURNS integer
    LANGUAGE c
    AS $$idx$$;
--
-- Name: intarray_del_elem(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.intarray_del_elem() RETURNS ARRAY
    LANGUAGE c
    AS $$intarray_del_elem$$;
--
-- Name: intarray_push_array(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.intarray_push_array() RETURNS ARRAY
    LANGUAGE c
    AS $$intarray_push_array$$;
--
-- Name: intarray_push_elem(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.intarray_push_elem() RETURNS ARRAY
    LANGUAGE c
    AS $$intarray_push_elem$$;
--
-- Name: intset(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.intset() RETURNS ARRAY
    LANGUAGE c
    AS $$intset$$;
--
-- Name: intset_subtract(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.intset_subtract() RETURNS ARRAY
    LANGUAGE c
    AS $$intset_subtract$$;
--
-- Name: intset_union_elem(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.intset_union_elem() RETURNS ARRAY
    LANGUAGE c
    AS $$intset_union_elem$$;
--
...
$$;
--
-- Name: isdefined(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.isdefined() RETURNS boolean
    LANGUAGE c
    AS $$hstore_defined$$;
--
-- Name: isexists(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.isexists() RETURNS boolean
    LANGUAGE c
    AS $$hstore_exists$$;
--
...
$$;
--
-- Name: pg_stat_statements(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pg_stat_statements() RETURNS record
    LANGUAGE c
    AS $$pg_stat_statements_1_11$$;
--
-- Name: pg_stat_statements_info(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pg_stat_statements_info() RETURNS record
    LANGUAGE c
    AS $$pg_stat_statements_info$$;
--
-- Name: pg_stat_statements_reset(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pg_stat_statements_reset() RETURNS timestamp with time zone
    LANGUAGE c
    AS $$pg_stat_statements_reset_1_11$$;
--
-- Name: pgp_armor_headers(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_armor_headers() RETURNS record
    LANGUAGE c
    AS $$pgp_armor_headers$$;
--
-- Name: pgp_key_id(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_key_id() RETURNS text
    LANGUAGE c
    AS $$pgp_key_id_w$$;
--
-- Name: pgp_pub_decrypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_pub_decrypt() RETURNS text
    LANGUAGE c
    AS $$pgp_pub_decrypt_text$$;
--
-- Name: pgp_pub_decrypt_bytea(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_pub_decrypt_bytea() RETURNS bytea
    LANGUAGE c
    AS $$pgp_pub_decrypt_bytea$$;
--
-- Name: pgp_pub_encrypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_pub_encrypt() RETURNS bytea
    LANGUAGE c
    AS $$pgp_pub_encrypt_text$$;
--
-- Name: pgp_pub_encrypt_bytea(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_pub_encrypt_bytea() RETURNS bytea
    LANGUAGE c
    AS $$pgp_pub_encrypt_bytea$$;
--
-- Name: pgp_sym_decrypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_sym_decrypt() RETURNS text
    LANGUAGE c
    AS $$pgp_sym_decrypt_text$$;
--
-- Name: pgp_sym_decrypt_bytea(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_sym_decrypt_bytea() RETURNS bytea
    LANGUAGE c
    AS $$pgp_sym_decrypt_bytea$$;
--
-- Name: pgp_sym_encrypt(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_sym_encrypt() RETURNS bytea
    LANGUAGE c
    AS $$pgp_sym_encrypt_text$$;
--
-- Name: pgp_sym_encrypt_bytea(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.pgp_sym_encrypt_bytea() RETURNS bytea
    LANGUAGE c
    AS $$pgp_sym_encrypt_bytea$$;
--
-- Name: populate_record(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.populate_record() RETURNS anyelement
    LANGUAGE c
    AS $$hstore_populate_record$$;
--
-- Name: querytree(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.querytree() RETURNS text
    LANGUAGE c
    AS $$querytree$$;
--
-- Name: rboolop(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.rboolop() RETURNS boolean
    LANGUAGE c
    AS $$rboolop$$;
--
...
$$;
--
-- Name: regexp_match(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.regexp_match() RETURNS ARRAY
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.regexp_match( $1::pg_catalog.text, $2::pg_catalog.text, 'i' );
$$;
--
-- Name: regexp_matches(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.regexp_matches() RETURNS ARRAY
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.regexp_matches( $1::pg_catalog.text, $2::pg_catalog.text, CASE WHEN pg_catalog.strpos($3, 'c') = 0 THEN  $3 || 'i' ELSE $3 END );
$$;
--
-- Name: regexp_replace(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.regexp_replace() RETURNS text
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.regexp_replace( $1::pg_catalog.text, $2::pg_catalog.text, $3, CASE WHEN pg_catalog.strpos($4, 'c') = 0 THEN  $4 || 'i' ELSE $4 END);
$$;
--
-- Name: regexp_split_to_array(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.regexp_split_to_array() RETURNS ARRAY
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.regexp_split_to_array( $1::pg_catalog.text, $2::pg_catalog.text, 'i' );
$$;
--
-- Name: regexp_split_to_table(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.regexp_split_to_table() RETURNS text
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.regexp_split_to_table( $1::pg_catalog.text, $2::pg_catalog.text, 'i' );
$$;
--
-- Name: replace(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.replace() RETURNS text
    LANGUAGE sql
    AS $$
...
$$;
--
-- Name: set_limit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_limit() RETURNS real
    LANGUAGE c
    AS $$set_limit$$;
--
...
CREATE FUNCTION public.show_limit() RETURNS real
    ...
    AS $$show_limit$$;
--
-- Name: show_trgm(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.show_trgm() RETURNS ARRAY
    LANGUAGE c
    AS $$show_trgm$$;
--
-- Name: similarity(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.similarity() RETURNS real
    LANGUAGE c
    AS $$similarity$$;
--
-- Name: similarity_dist(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.similarity_dist() RETURNS real
    LANGUAGE c
    AS $$similarity_dist$$;
--
-- Name: similarity_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.similarity_op() RETURNS boolean
    LANGUAGE c
    AS $$similarity_op$$;
--
-- Name: skeys(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.skeys() RETURNS text
    LANGUAGE c
    AS $$hstore_skeys$$;
--
-- Name: slice(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.slice() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_slice_to_hstore$$;
--
-- Name: slice_array(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.slice_array() RETURNS ARRAY
    LANGUAGE c
    AS $$hstore_slice_to_array$$;
--
...
$$;
--
-- Name: sort(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sort() RETURNS ARRAY
    LANGUAGE c
    AS $$sort$$;
--
-- Name: sort_asc(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sort_asc() RETURNS ARRAY
    LANGUAGE c
    AS $$sort_asc$$;
--
-- Name: sort_desc(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.sort_desc() RETURNS ARRAY
    LANGUAGE c
    AS $$sort_desc$$;
--
-- Name: split_part(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.split_part() RETURNS text
    LANGUAGE sql
    AS $$
    SELECT (pg_catalog.regexp_split_to_array( $1::pg_catalog.text, pg_catalog.regexp_replace($2::pg_catalog.text, '([^a-zA-Z_0-9])', E'\\\\\\1', 'g'), 'i'))[$3];
$$;
--
-- Name: strict_word_similarity(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.strict_word_similarity() RETURNS real
    LANGUAGE c
    AS $$strict_word_similarity$$;
--
-- Name: strict_word_similarity_commutator_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.strict_word_similarity_commutator_op() RETURNS boolean
    LANGUAGE c
    AS $$strict_word_similarity_commutator_op$$;
--
-- Name: strict_word_similarity_dist_commutator_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.strict_word_similarity_dist_commutator_op() RETURNS real
    LANGUAGE c
    AS $$strict_word_similarity_dist_commutator_op$$;
--
-- Name: strict_word_similarity_dist_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.strict_word_similarity_dist_op() RETURNS real
    LANGUAGE c
    AS $$strict_word_similarity_dist_op$$;
--
-- Name: strict_word_similarity_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.strict_word_similarity_op() RETURNS boolean
    LANGUAGE c
    AS $$strict_word_similarity_op$$;
--
-- Name: strpos(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.strpos() RETURNS integer
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.strpos( pg_catalog.lower( $1::pg_catalog.text ), pg_catalog.lower( $2::pg_catalog.text ) );
$$;
--
-- Name: subarray(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.subarray() RETURNS ARRAY
    LANGUAGE c
    AS $$subarray$$;
--
-- Name: svals(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.svals() RETURNS text
    LANGUAGE c
    AS $$hstore_svals$$;
--
-- Name: tconvert(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.tconvert() RETURNS USER-DEFINED
    LANGUAGE c
    AS $$hstore_from_text$$;
--
-- Name: texticlike(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.texticlike() RETURNS boolean
    LANGUAGE internal
    AS $$texticlike$$;
--
-- Name: texticnlike(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.texticnlike() RETURNS boolean
    LANGUAGE internal
    AS $$texticnlike$$;
--
-- Name: texticregexeq(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.texticregexeq() RETURNS boolean
    LANGUAGE internal
    AS $$texticregexeq$$;
--
-- Name: texticregexne(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.texticregexne() RETURNS boolean
    LANGUAGE internal
    AS $$texticregexne$$;
--
-- Name: translate(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.translate() RETURNS text
    LANGUAGE sql
    AS $$
    SELECT pg_catalog.translate( pg_catalog.translate( $1::pg_catalog.text, pg_catalog.lower($2::pg_catalog.text), $3), pg_catalog.upper($2::pg_catalog.text), $3);
$$;
--
-- Name: uniq(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.uniq() RETURNS ARRAY
    LANGUAGE c
    AS $$uniq$$;
--
...
END $$;
--
-- Name: word_similarity(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.word_similarity() RETURNS real
    LANGUAGE c
    AS $$word_similarity$$;
--
-- Name: word_similarity_commutator_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.word_similarity_commutator_op() RETURNS boolean
    LANGUAGE c
    AS $$word_similarity_commutator_op$$;
--
-- Name: word_similarity_dist_commutator_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.word_similarity_dist_commutator_op() RETURNS real
    LANGUAGE c
    AS $$word_similarity_dist_commutator_op$$;
--
-- Name: word_similarity_dist_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.word_similarity_dist_op() RETURNS real
    LANGUAGE c
    AS $$word_similarity_dist_op$$;
--
-- Name: word_similarity_op(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.word_similarity_op() RETURNS boolean
    LANGUAGE c
    AS $$word_similarity_op$$;
...
--
-- Name: external_service_sync_jobs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.external_service_sync_jobs_id_seq OWNED BY public.external_service_sync_jobs.id;
...
CREATE TABLE public.orgs (
    ...
    CONSTRAINT orgs_name_valid_chars CHECK ((name ~ '^[a-zA-Z0-9](?:[a-zA-Z0-9]|[-.](?=[a-zA-Z0-9]))*-?$'::citext))
);
...
CREATE TABLE public.prompts (
    ...
    CONSTRAINT prompts_name_valid_chars CHECK ((name ~ '^[a-zA-Z0-9](?:[a-zA-Z0-9]|[-.](?=[a-zA-Z0-9]))*-?$'::citext))
);
...
CREATE TABLE public.registry_extensions (
    ...
    CONSTRAINT registry_extensions_name_valid_chars CHECK ((name ~ '^[a-zA-Z0-9](?:[a-zA-Z0-9]|[_.-](?=[a-zA-Z0-9]))*$'::citext)),
...
CREATE TABLE public.repo (
    ...
    topics text[],
    tenant_id integer,
    CONSTRAINT check_name_nonempty CHECK ((name <> ''::citext)),
...
CREATE TABLE public.teams (
    ...
    CONSTRAINT teams_name_valid_chars CHECK ((name ~ '^[a-zA-Z0-9](?:[a-zA-Z0-9]|[-.](?=[a-zA-Z0-9]))*-?$'::citext))
);
...
CREATE TABLE public.users (
    ...
    CONSTRAINT users_username_valid_chars CHECK ((username ~ '^\w(?:\w|[-.](?=\w))*-?$'::citext))
);
...
ALTER TABLE ONLY public.access_requests ALTER COLUMN id SET DEFAULT nextval('access_requests_id_seq'::regclass);
...
ALTER TABLE ONLY public.access_tokens ALTER COLUMN id SET DEFAULT nextval('access_tokens_id_seq'::regclass);
...
ALTER TABLE ONLY public.assigned_owners ALTER COLUMN id SET DEFAULT nextval('assigned_owners_id_seq'::regclass);
...
ALTER TABLE ONLY public.assigned_teams ALTER COLUMN id SET DEFAULT nextval('assigned_teams_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_changes ALTER COLUMN id SET DEFAULT nextval('batch_changes_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_changes_site_credentials ALTER COLUMN id SET DEFAULT nextval('batch_changes_site_credentials_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_spec_execution_cache_entries ALTER COLUMN id SET DEFAULT nextval('batch_spec_execution_cache_entries_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_spec_resolution_jobs ALTER COLUMN id SET DEFAULT nextval('batch_spec_resolution_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_spec_workspace_execution_jobs ALTER COLUMN id SET DEFAULT nextval('batch_spec_workspace_execution_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_spec_workspace_files ALTER COLUMN id SET DEFAULT nextval('batch_spec_workspace_files_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_spec_workspaces ALTER COLUMN id SET DEFAULT nextval('batch_spec_workspaces_id_seq'::regclass);
...
ALTER TABLE ONLY public.batch_specs ALTER COLUMN id SET DEFAULT nextval('batch_specs_id_seq'::regclass);
...
ALTER TABLE ONLY public.cached_available_indexers ALTER COLUMN id SET DEFAULT nextval('cached_available_indexers_id_seq'::regclass);
...
ALTER TABLE ONLY public.changeset_events ALTER COLUMN id SET DEFAULT nextval('changeset_events_id_seq'::regclass);
...
ALTER TABLE ONLY public.changeset_jobs ALTER COLUMN id SET DEFAULT nextval('changeset_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.changeset_specs ALTER COLUMN id SET DEFAULT nextval('changeset_specs_id_seq'::regclass);
...
ALTER TABLE ONLY public.changesets ALTER COLUMN id SET DEFAULT nextval('changesets_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_action_jobs ALTER COLUMN id SET DEFAULT nextval('cm_action_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_emails ALTER COLUMN id SET DEFAULT nextval('cm_emails_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_monitors ALTER COLUMN id SET DEFAULT nextval('cm_monitors_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_queries ALTER COLUMN id SET DEFAULT nextval('cm_queries_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_recipients ALTER COLUMN id SET DEFAULT nextval('cm_recipients_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_slack_webhooks ALTER COLUMN id SET DEFAULT nextval('cm_slack_webhooks_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_trigger_jobs ALTER COLUMN id SET DEFAULT nextval('cm_trigger_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.cm_webhooks ALTER COLUMN id SET DEFAULT nextval('cm_webhooks_id_seq'::regclass);
...
ALTER TABLE ONLY public.code_hosts ALTER COLUMN id SET DEFAULT nextval('code_hosts_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_autoindex_queue ALTER COLUMN id SET DEFAULT nextval('codeintel_autoindex_queue_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_autoindexing_exceptions ALTER COLUMN id SET DEFAULT nextval('codeintel_autoindexing_exceptions_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_initial_path_ranks ALTER COLUMN id SET DEFAULT nextval('codeintel_initial_path_ranks_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_initial_path_ranks_processed ALTER COLUMN id SET DEFAULT nextval('codeintel_initial_path_ranks_processed_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_langugage_support_requests ALTER COLUMN id SET DEFAULT nextval('codeintel_langugage_support_requests_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_path_ranks ALTER COLUMN id SET DEFAULT nextval('codeintel_path_ranks_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_definitions ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_definitions_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_exports ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_exports_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_graph_keys ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_graph_keys_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_path_counts_inputs ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_path_counts_inputs_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_progress ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_progress_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_references ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_references_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeintel_ranking_references_processed ALTER COLUMN id SET DEFAULT nextval('codeintel_ranking_references_processed_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeowners ALTER COLUMN id SET DEFAULT nextval('codeowners_id_seq'::regclass);
...
ALTER TABLE ONLY public.codeowners_owners ALTER COLUMN id SET DEFAULT nextval('codeowners_owners_id_seq'::regclass);
...
ALTER TABLE ONLY public.commit_authors ALTER COLUMN id SET DEFAULT nextval('commit_authors_id_seq'::regclass);
...
ALTER TABLE ONLY public.configuration_policies_audit_logs ALTER COLUMN sequence SET DEFAULT nextval('configuration_policies_audit_logs_seq'::regclass);
...
ALTER TABLE ONLY public.context_detection_embedding_jobs ALTER COLUMN id SET DEFAULT nextval('context_detection_embedding_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.critical_and_site_config ALTER COLUMN id SET DEFAULT nextval('critical_and_site_config_id_seq'::regclass);
...
ALTER TABLE ONLY public.discussion_comments ALTER COLUMN id SET DEFAULT nextval('discussion_comments_id_seq'::regclass);
...
ALTER TABLE ONLY public.discussion_threads ALTER COLUMN id SET DEFAULT nextval('discussion_threads_id_seq'::regclass);
...
ALTER TABLE ONLY public.discussion_threads_target_repo ALTER COLUMN id SET DEFAULT nextval('discussion_threads_target_repo_id_seq'::regclass);
...
ALTER TABLE ONLY public.event_logs ALTER COLUMN id SET DEFAULT nextval('event_logs_id_seq'::regclass);
...
ALTER TABLE ONLY public.event_logs_export_allowlist ALTER COLUMN id SET DEFAULT nextval('event_logs_export_allowlist_id_seq'::regclass);
...
ALTER TABLE ONLY public.event_logs_scrape_state ALTER COLUMN id SET DEFAULT nextval('event_logs_scrape_state_id_seq'::regclass);
...
ALTER TABLE ONLY public.event_logs_scrape_state_own ALTER COLUMN id SET DEFAULT nextval('event_logs_scrape_state_own_id_seq'::regclass);
...
ALTER TABLE ONLY public.executor_heartbeats ALTER COLUMN id SET DEFAULT nextval('executor_heartbeats_id_seq'::regclass);
...
ALTER TABLE ONLY public.executor_job_tokens ALTER COLUMN id SET DEFAULT nextval('executor_job_tokens_id_seq'::regclass);
...
ALTER TABLE ONLY public.executor_secret_access_logs ALTER COLUMN id SET DEFAULT nextval('executor_secret_access_logs_id_seq'::regclass);
...
ALTER TABLE ONLY public.executor_secrets ALTER COLUMN id SET DEFAULT nextval('executor_secrets_id_seq'::regclass);
...
ALTER TABLE ONLY public.exhaustive_search_jobs ALTER COLUMN id SET DEFAULT nextval('exhaustive_search_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.exhaustive_search_repo_jobs ALTER COLUMN id SET DEFAULT nextval('exhaustive_search_repo_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.exhaustive_search_repo_revision_jobs ALTER COLUMN id SET DEFAULT nextval('exhaustive_search_repo_revision_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.explicit_permissions_bitbucket_projects_jobs ALTER COLUMN id SET DEFAULT nextval('explicit_permissions_bitbucket_projects_jobs_id_seq'::regclass);


--
-- Name: external_service_sync_jobs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.external_service_sync_jobs ALTER COLUMN id SET DEFAULT nextval('external_service_sync_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.external_services ALTER COLUMN id SET DEFAULT nextval('external_services_id_seq'::regclass);
...
ALTER TABLE ONLY public.github_app_installs ALTER COLUMN id SET DEFAULT nextval('github_app_installs_id_seq'::regclass);
...
ALTER TABLE ONLY public.github_apps ALTER COLUMN id SET DEFAULT nextval('github_apps_id_seq'::regclass);
...
ALTER TABLE ONLY public.gitserver_relocator_jobs ALTER COLUMN id SET DEFAULT nextval('gitserver_relocator_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.insights_query_runner_jobs ALTER COLUMN id SET DEFAULT nextval('insights_query_runner_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.insights_query_runner_jobs_dependencies ALTER COLUMN id SET DEFAULT nextval('insights_query_runner_jobs_dependencies_id_seq'::regclass);
...
ALTER TABLE ONLY public.insights_settings_migration_jobs ALTER COLUMN id SET DEFAULT nextval('insights_settings_migration_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_configuration_policies ALTER COLUMN id SET DEFAULT nextval('lsif_configuration_policies_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_dependency_indexing_jobs ALTER COLUMN id SET DEFAULT nextval('lsif_dependency_indexing_jobs_id_seq1'::regclass);
...
ALTER TABLE ONLY public.lsif_dependency_repos ALTER COLUMN id SET DEFAULT nextval('lsif_dependency_repos_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_dependency_syncing_jobs ALTER COLUMN id SET DEFAULT nextval('lsif_dependency_indexing_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_index_configuration ALTER COLUMN id SET DEFAULT nextval('lsif_index_configuration_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_indexes ALTER COLUMN id SET DEFAULT nextval('lsif_indexes_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_packages ALTER COLUMN id SET DEFAULT nextval('lsif_packages_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_references ALTER COLUMN id SET DEFAULT nextval('lsif_references_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_retention_configuration ALTER COLUMN id SET DEFAULT nextval('lsif_retention_configuration_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_uploads ALTER COLUMN id SET DEFAULT nextval('lsif_dumps_id_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_uploads_audit_logs ALTER COLUMN sequence SET DEFAULT nextval('lsif_uploads_audit_logs_seq'::regclass);
...
ALTER TABLE ONLY public.lsif_uploads_vulnerability_scan ALTER COLUMN id SET DEFAULT nextval('lsif_uploads_vulnerability_scan_id_seq'::regclass);
...
ALTER TABLE ONLY public.namespace_permissions ALTER COLUMN id SET DEFAULT nextval('namespace_permissions_id_seq'::regclass);
...
ALTER TABLE ONLY public.notebooks ALTER COLUMN id SET DEFAULT nextval('notebooks_id_seq'::regclass);
...
ALTER TABLE ONLY public.org_invitations ALTER COLUMN id SET DEFAULT nextval('org_invitations_id_seq'::regclass);
...
ALTER TABLE ONLY public.org_members ALTER COLUMN id SET DEFAULT nextval('org_members_id_seq'::regclass);
...
ALTER TABLE ONLY public.orgs ALTER COLUMN id SET DEFAULT nextval('orgs_id_seq'::regclass);
...
ALTER TABLE ONLY public.out_of_band_migrations ALTER COLUMN id SET DEFAULT nextval('out_of_band_migrations_id_seq'::regclass);
...
ALTER TABLE ONLY public.out_of_band_migrations_errors ALTER COLUMN id SET DEFAULT nextval('out_of_band_migrations_errors_id_seq'::regclass);
...
ALTER TABLE ONLY public.outbound_webhook_event_types ALTER COLUMN id SET DEFAULT nextval('outbound_webhook_event_types_id_seq'::regclass);
...
ALTER TABLE ONLY public.outbound_webhook_jobs ALTER COLUMN id SET DEFAULT nextval('outbound_webhook_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.outbound_webhook_logs ALTER COLUMN id SET DEFAULT nextval('outbound_webhook_logs_id_seq'::regclass);
...
ALTER TABLE ONLY public.outbound_webhooks ALTER COLUMN id SET DEFAULT nextval('outbound_webhooks_id_seq'::regclass);
...
ALTER TABLE ONLY public.own_aggregate_recent_contribution ALTER COLUMN id SET DEFAULT nextval('own_aggregate_recent_contribution_id_seq'::regclass);
...
ALTER TABLE ONLY public.own_aggregate_recent_view ALTER COLUMN id SET DEFAULT nextval('own_aggregate_recent_view_id_seq'::regclass);
...
ALTER TABLE ONLY public.own_background_jobs ALTER COLUMN id SET DEFAULT nextval('own_background_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.own_signal_configurations ALTER COLUMN id SET DEFAULT nextval('own_signal_configurations_id_seq'::regclass);
...
ALTER TABLE ONLY public.own_signal_recent_contribution ALTER COLUMN id SET DEFAULT nextval('own_signal_recent_contribution_id_seq'::regclass);
...
ALTER TABLE ONLY public.package_repo_filters ALTER COLUMN id SET DEFAULT nextval('package_repo_filters_id_seq'::regclass);
...
ALTER TABLE ONLY public.package_repo_versions ALTER COLUMN id SET DEFAULT nextval('package_repo_versions_id_seq'::regclass);
...
ALTER TABLE ONLY public.permission_sync_jobs ALTER COLUMN id SET DEFAULT nextval('permission_sync_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.phabricator_repos ALTER COLUMN id SET DEFAULT nextval('phabricator_repos_id_seq'::regclass);
...
ALTER TABLE ONLY public.prompts ALTER COLUMN id SET DEFAULT nextval('prompts_id_seq'::regclass);
...
ALTER TABLE ONLY public.registry_extension_releases ALTER COLUMN id SET DEFAULT nextval('registry_extension_releases_id_seq'::regclass);
...
ALTER TABLE ONLY public.registry_extensions ALTER COLUMN id SET DEFAULT nextval('registry_extensions_id_seq'::regclass);
...
ALTER TABLE ONLY public.repo ALTER COLUMN id SET DEFAULT nextval('repo_id_seq'::regclass);
...
ALTER TABLE ONLY public.repo_commits_changelists ALTER COLUMN id SET DEFAULT nextval('repo_commits_changelists_id_seq'::regclass);
...
ALTER TABLE ONLY public.repo_embedding_jobs ALTER COLUMN id SET DEFAULT nextval('repo_embedding_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.repo_paths ALTER COLUMN id SET DEFAULT nextval('repo_paths_id_seq'::regclass);
...
ALTER TABLE ONLY public.saved_searches ALTER COLUMN id SET DEFAULT nextval('saved_searches_id_seq'::regclass);
...
ALTER TABLE ONLY public.search_contexts ALTER COLUMN id SET DEFAULT nextval('search_contexts_id_seq'::regclass);
...
ALTER TABLE ONLY public.security_event_logs ALTER COLUMN id SET DEFAULT nextval('security_event_logs_id_seq'::regclass);
...
ALTER TABLE ONLY public.settings ALTER COLUMN id SET DEFAULT nextval('settings_id_seq'::regclass);
...
ALTER TABLE ONLY public.survey_responses ALTER COLUMN id SET DEFAULT nextval('survey_responses_id_seq'::regclass);
...
ALTER TABLE ONLY public.syntactic_scip_indexing_jobs ALTER COLUMN id SET DEFAULT nextval('syntactic_scip_indexing_jobs_id_seq'::regclass);
...
ALTER TABLE ONLY public.temporary_settings ALTER COLUMN id SET DEFAULT nextval('temporary_settings_id_seq'::regclass);
...
ALTER TABLE ONLY public.user_credentials ALTER COLUMN id SET DEFAULT nextval('user_credentials_id_seq'::regclass);
...
ALTER TABLE ONLY public.user_external_accounts ALTER COLUMN id SET DEFAULT nextval('user_external_accounts_id_seq'::regclass);
...
ALTER TABLE ONLY public.user_onboarding_tour ALTER COLUMN id SET DEFAULT nextval('user_onboarding_tour_id_seq'::regclass);
...
ALTER TABLE ONLY public.user_pending_permissions ALTER COLUMN id SET DEFAULT nextval('user_pending_permissions_id_seq'::regclass);
...
ALTER TABLE ONLY public.user_repo_permissions ALTER COLUMN id SET DEFAULT nextval('user_repo_permissions_id_seq'::regclass);
...
ALTER TABLE ONLY public.vulnerabilities ALTER COLUMN id SET DEFAULT nextval('vulnerabilities_id_seq'::regclass);
...
ALTER TABLE ONLY public.vulnerability_affected_packages ALTER COLUMN id SET DEFAULT nextval('vulnerability_affected_packages_id_seq'::regclass);
...
ALTER TABLE ONLY public.vulnerability_affected_symbols ALTER COLUMN id SET DEFAULT nextval('vulnerability_affected_symbols_id_seq'::regclass);
...
ALTER TABLE ONLY public.vulnerability_matches ALTER COLUMN id SET DEFAULT nextval('vulnerability_matches_id_seq'::regclass);
...
ALTER TABLE ONLY public.webhook_logs ALTER COLUMN id SET DEFAULT nextval('webhook_logs_id_seq'::regclass);
...
ALTER TABLE ONLY public.webhooks ALTER COLUMN id SET DEFAULT nextval('webhooks_id_seq'::regclass);
...
ALTER TABLE ONLY public.redis_key_value
    ADD CONSTRAINT redis_key_value_pkey PRIMARY KEY (namespace, key);
...
ALTER TABLE ONLY public.repo
    ADD CONSTRAINT repo_name_unique UNIQUE (name);
...
ALTER TABLE ONLY public.repo_kvps
    ADD CONSTRAINT repo_kvps_pkey PRIMARY KEY (repo_id, key);
...
CREATE INDEX access_tokens_lookup_double_hash ON public.access_tokens USING hash (digest(value_sha256, 'sha256'::text)) WHERE (deleted_at IS NULL);
...
CREATE INDEX lsif_dependency_repos_name_gin ON public.lsif_dependency_repos USING gin (name gin_trgm_ops);
...
CREATE INDEX notebooks_title_trgm_idx ON public.notebooks USING gin (title gin_trgm_ops);
...
CREATE INDEX repo_description_trgm_idx ON public.repo USING gin (lower(description) gin_trgm_ops);
...
CREATE INDEX repo_kvps_trgm_idx ON public.repo_kvps USING gin (key gin_trgm_ops, value gin_trgm_ops);
...
CREATE INDEX repo_name_case_sensitive_trgm_idx ON public.repo USING gin (((name)::text) gin_trgm_ops);
...
CREATE INDEX repo_name_trgm ON public.repo USING gin (lower((name)::text) gin_trgm_ops);
...
--
-- Name: user_emails_unique_verified_email; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX user_emails_unique_verified_email ON public.user_emails USING btree (email) WHERE (verified_at IS NOT NULL);
...
CREATE TRIGGER batch_spec_workspace_execution_last_dequeues_insert AFTER INSERT ON public.batch_spec_workspace_execution_jobs FOR EACH ROW EXECUTE FUNCTION public.batch_spec_workspace_execution_last_dequeues_upsert();
...
CREATE TRIGGER batch_spec_workspace_execution_last_dequeues_update AFTER UPDATE ON public.batch_spec_workspace_execution_jobs FOR EACH ROW EXECUTE FUNCTION public.batch_spec_workspace_execution_last_dequeues_upsert();
...
CREATE TRIGGER trig_delete_repo_ref_on_external_service_repos AFTER UPDATE ON public.repo FOR EACH ROW EXECUTE FUNCTION public.delete_repo_ref_on_external_service_repos();
...
CREATE TRIGGER trig_delete_user_repo_permissions_on_external_account_soft_dele AFTER UPDATE ON public.user_external_accounts FOR EACH ROW EXECUTE FUNCTION public.delete_user_repo_permissions_on_external_account_soft_delete();
...
CREATE TRIGGER trig_delete_user_repo_permissions_on_repo_soft_delete AFTER UPDATE ON public.repo FOR EACH ROW EXECUTE FUNCTION public.delete_user_repo_permissions_on_repo_soft_delete();
...
CREATE TRIGGER trig_delete_user_repo_permissions_on_user_soft_delete AFTER UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.delete_user_repo_permissions_on_user_soft_delete();
...
CREATE TRIGGER trig_invalidate_session_on_password_change BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.invalidate_session_for_userid_on_password_change();
...
CREATE TRIGGER trig_recalc_gitserver_repos_statistics_on_delete AFTER DELETE ON public.gitserver_repos FOR EACH ROW EXECUTE FUNCTION public.recalc_gitserver_repos_statistics_on_delete();
...
CREATE TRIGGER trig_recalc_gitserver_repos_statistics_on_insert AFTER INSERT ON public.gitserver_repos FOR EACH ROW EXECUTE FUNCTION public.recalc_gitserver_repos_statistics_on_insert();
...
CREATE TRIGGER trig_recalc_gitserver_repos_statistics_on_update AFTER UPDATE ON public.gitserver_repos FOR EACH ROW EXECUTE FUNCTION public.recalc_gitserver_repos_statistics_on_update();
...
CREATE TRIGGER trig_recalc_repo_statistics_on_repo_delete AFTER DELETE ON public.repo FOR EACH ROW EXECUTE FUNCTION public.recalc_repo_statistics_on_repo_delete();
...
CREATE TRIGGER trig_recalc_repo_statistics_on_repo_insert AFTER INSERT ON public.repo FOR EACH ROW EXECUTE FUNCTION public.recalc_repo_statistics_on_repo_insert();
...
CREATE TRIGGER trig_recalc_repo_statistics_on_repo_update AFTER UPDATE ON public.repo FOR EACH ROW EXECUTE FUNCTION public.recalc_repo_statistics_on_repo_update();
...
CREATE TRIGGER trigger_configuration_policies_delete AFTER DELETE ON public.lsif_configuration_policies FOR EACH ROW EXECUTE FUNCTION public.func_configuration_policies_delete();
...
CREATE TRIGGER trigger_configuration_policies_update BEFORE UPDATE ON public.lsif_configuration_policies FOR EACH ROW EXECUTE FUNCTION public.func_configuration_policies_update();
...
CREATE TRIGGER trigger_lsif_uploads_delete AFTER DELETE ON public.lsif_uploads FOR EACH ROW EXECUTE FUNCTION public.func_lsif_uploads_delete();
...
CREATE TRIGGER trigger_lsif_uploads_update BEFORE UPDATE ON public.lsif_uploads FOR EACH ROW EXECUTE FUNCTION public.func_lsif_uploads_update();
...
CREATE TRIGGER trigger_package_repo_filters_updated_at BEFORE UPDATE ON public.package_repo_filters FOR EACH ROW EXECUTE FUNCTION public.func_package_repo_filters_updated_at();
...
CREATE TRIGGER update_codeintel_path_ranks_statistics BEFORE UPDATE ON public.codeintel_path_ranks FOR EACH ROW EXECUTE FUNCTION public.update_codeintel_path_ranks_statistics_columns();
...
CREATE TRIGGER update_codeintel_path_ranks_updated_at BEFORE UPDATE ON public.codeintel_path_ranks FOR EACH ROW EXECUTE FUNCTION public.update_codeintel_path_ranks_updated_at_column();
