---
title: "Multi-File Schema Management"
---

For large schemas and teams, managing your database schema as a single file becomes unwieldy. The [`--multi-file`](/cli/dump#param-multi-file) option allows you to split your schema into multiple files organized by database objects, enabling better collaboration, clearer ownership, and easier maintenance.
