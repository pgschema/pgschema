...
Both Supabase and pgschema offer this declarative workflow for PostgreSQL. Recently, we've seen users [migrating from Supabase's declarative schemas to pgschema](https://github.com/pgschema/pgschema/issues/227). This article compares both tools to help you understand when each makes sense.
...
For those who are considering migrating from Supabase declarative schema to pgschema, you can check out the experience/gaps from the [community discussion](https://github.com/pgschema/pgschema/issues/227).
